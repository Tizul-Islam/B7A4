  ...
  return (
    <div className="space-y-8 pb-16">
      <div>
        ...
        <p className="text-sm text-slate-400">Add or remove outdoor gear categories</p>
      </div>

      <div className="grid md:grid-cols-[300px_1fr] gap-8 items-start">
        {/* Creation Form */}
        <div className="rounded-2xl border border-white/5 bg-slate-900/60 p-6 backdrop-blur-md">
          <h3 className="font-display text-lg font-bold text-white mb-4">Create Category</h3>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <button
              ...
              className="w-full rounded-xl bg-accentTeal py-2.5 font-display text-sm font-bold text-white hover:bg-accentTealHover disabled:opacity-40 transition-all flex items-center justify-center"
            >
              ...
              <tr key={cat.id}>
                ...
                <td className="px-6 py-4">
                  <button
                    ...
                    className="inline-flex h-8 w-8 items-center justify-center rounded-lg border border-rose-900/50 bg-rose-950/40 text-rose-400 hover:bg-rose-900 hover:text-white disabled:opacity-30"
                  >
                    {isDeleting ? (
