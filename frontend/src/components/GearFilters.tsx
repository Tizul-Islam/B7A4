...
export const GearFilters: React.FC<GearFiltersProps> = ({
  ...
  return (
    <div className="flex flex-col gap-6 rounded-2xl border border-white/5 bg-slate-900/60 p-6 backdrop-blur-md">
      {/* Search Input */}
      <div>
        <label htmlFor="search-input" className="block font-display text-xs font-black uppercase tracking-wider text-slate-400 mb-3">
          Search
        </label>
      ...
      {/* Category Dropdown */}
      <div>
        <label htmlFor="category-select" className="block font-display text-xs font-black uppercase tracking-wider text-slate-400 mb-3">
          Category
        </label>
        <select
          id="category-select"
      ...
      {/* Condition Dropdown */}
      <div>
        <label htmlFor="condition-select" className="block font-display text-xs font-black uppercase tracking-wider text-slate-400 mb-3">
          Condition
        </label>
        <select
          id="condition-select"
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          <label htmlFor="price-slider" className="font-display text-xs font-black uppercase tracking-wider text-slate-400">
            Max Price / Day
          </label>
